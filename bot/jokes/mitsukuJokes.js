// Source: http://www.square-bear.co.uk/aiml/
...
const jokes = [
	...
	'Two men walking their dogs pass each other in a graveyard. The first man says to the second, "Morning."\n"No", says the second man. "Just walking the dog."',
	'A brain went into a bar and said, "Can I have a pint of lager please, mate?"\n"No way", said the barman. "You\'re already out of your head."',
	...
	'A grizzly bear walks into a pub and says, "Can I have a pint of lager..............................................................................................................................and a packet of crisps please."\nTo which the barman replies, "Why the big paws?"',
	...
	'A woman goes into a US sporting goods store to buy a rifle. "It\'s for my husband", she tells the clerk.\n"Did he tell you what gauge to get?" asks the clerk.\nAre you kidding?" she says. "He doesn\'t even know that I\'m going to shoot him!"',
	'A couple are dining in a restaurant when the man suddenly slides under the table. A waitress, noticing that the woman is glancing nonchalantly around the room, wanders over to check that there\'s no funny business going on.\n"Excuse me, madam", she smarms, "but I think your husband has just slid under the table."\n"No he hasn\'t", the woman replies. "As a matter of fact, he\'s just walked in."',
	'An old man takes his two grandchildren to see the new Scooby-Doo film. When he returns home, his wife asks if he enjoyed himself.\n"Well", he starts, "if it wasn\'t for those pesky kids...!"',
	'The Olympic committee has just announced that Origami is to be introduced in the next Olympic Games.\nUnfortunately it will only be available on paper view.',
	'Late one evening, a man is watching television when his phone rings. "Hello?" he answers. "Is that 77777?" sounds a desperate voice on other end of the phone.\n"Er, yes it is", replies the man puzzled.\n"Thank goodness!" cries the caller relieved. "Can you ring 999 for me? I\'ve got my finger stuck in the number seven."',
	...
	'A bloke walks into work one day and says to a colleague, "Do you like my new shirt - it\'s made out of the finest silk and got loads of cactuses over it."\n"Cacti", says the co-worker.\n"Forget my tie", says the bloke. "Look at my shirt!"',
	'What did the plumber say when he wanted to divorce his wife?\nSorry, but it\'s over, Flo!',
	'Two crisps were walking down a road when a taxi pulled up alongside them and said "Do you want a lift?\nOne of the crisps replied, "No thanks, we\'re Walkers!"',
	...
	'A wife was having a go at her husband. "Look at Mr Barnes across the road", she moaned. "Every morning when he goes to work, he kisses his wife goodbye. Why don\'t you do that?"\n"Because I haven\'t been introduced to her yet", replied her old man.',
	'"Where are you going on holiday?" John asked Trevor.\n"We\'re off to Thailand this year", Trevor replied.\n"Oh; aren\'t you worried that the very hot weather might disagree with your wife?" asked John.\n"It wouldn\'t dare", said Trevor.',
	'Two women were standing at a funeral. "I blame myself for his death", said the wife.\n"Why?" said her friend.\n"Because I shot him", said the wife.',
	...
	'Van Gogh goes into a pub and his mate asks him if he wants a drink.\n"No thanks", said Vincent, "I\'ve got one ear."',
	'A pony walks into a pub. The publican says, "What\'s the matter with you?"\n"Oh it\'s nothing", says the pony. "I\'m just a little horse!"',
	'A white horse walks into a bar, pulls up a stool, and orders a pint. The landlord pours him a tall frothy mug and say, "You know, we have a drink named after you."\nTo which the white horse replies, "What, Eric?"',
	'Two drunk men sat in a pub. One says to the other, "Does your watch tell the time?"\n"The other replies, "No, mate. You have to look at it."',
	'A man goes into a pub with a newt sitting on his shoulder.\n"That\'s a nice newt", says the landlord, "What\'s he called?"\n"Tiny", replies the man.\n"Why\'s that?" asks the landlord.\n"Because he\'s my newt", says the man.',
	'Doctor: I have some bad news and some very bad news.\nPatient: Well, you might as well give me the bad news first.\nDoctor: The lab called with your test results. They said you have 24 hours to live.\nPatient: 24 HOURS! That\'s terrible!! WHAT could be WORSE? What\'s the very bad news?\nDoctor: I\'ve been trying to reach you since yesterday.',
	'Two men are chatting in a pub one day.\n"How did you get those scars on your nose?" said one.\n"From glasses", said the other.\n"Well why don\'t you try contact lenses?" asked the first.\n"Because they don\'t hold as much beer", said the second.',
	'A man went to the doctor, "Look doc", he said, "I can\'t stop my hands from shaking."\n"Do you drink much?" asked the doctor.\n"No", replied the man, "I spill most of it."',
	'Man goes to the doctor, "Doctor, doctor. I keep seeing fish everywhere."\n"Have you seen an optician?" asks the doctor.\n"Look I told you," snapped the patient, "It\'s fish that I see."',
	'After a car crash one of the drivers was lying injured on the pavement.\n"Don\'t worry", said a policeman who\'s first on the scene," a Red Cross nurse is coming."\n"Oh no", moaned the victim, "Couldn\'t I have a blonde, cheerful one instead?"',
	'A policeman walked over to a parked car and asked the driver if the car was licensed. "Of course it is", said the driver.\n"Great, I\'ll have a beer then", said the policeman.',
	'A policeman stops a woman and asks for her licence.\n"Madam", he says, "It says here that you should be wearing glasses."\n"Well", replies the woman, "I have contacts."\n"Listen, love", says the copper, "I don\'t care who you know; You\'re nicked!"',
	'A policeman stopped a motorist in the centre of town one evening. "Would you mind blowing into this bag, sir?" asked the policeman.\n"Why?" asked the driver.\n"Because my chips are too hot", replied the policeman.',
	'Whizzing round a sharp bend on a country road a motorist ran over a large dog. A distraught farmer\'s wife ran over to the dead animal.\n"I\'m so very sorry", said the driver, "I\'ll replace him, of course."\n"Well, I don\'t know", said the farmer\'s wife, "Are you any good at catching rats?"',
	...
	'"Is your mother home?" the salesman asked a small boy sitting on the front step of a house.\n"Yeah, she\'s home", the boy said, moving over to let him past. The salesman rang the doorbell, got no response, knocked once, then again. Still no-one came to the door. Turning to the boy, the salesman said, "I thought you said your mother was home."\nThe kid replied, "She is, but I don\'t live here."',
	...
	'A newly-wed couple had recently opened a joint bank account. "Darling", said the man. "The bank has returned that cheque you wrote last week."\n"Great", said the woman. "What shall I spend it on next?"',
	'A man goes into a fish and chip shop and orders fish and chips twice. The shop owner says, "I heard you the first time."',
	'A tramp approached a well-dressed man. "Ten pence for a cup of tea, Guv?" He asked.\nThe man gave him the money and after for five minutes said, "So where\'s my cup of tea then?"',
	'A neutron walks into a pub. "I\'d like a beer", he says. The landlord promptly serves him a beer. "How much will that be?" asks the neutron.\n"For you?" replies the landlord, "No charge."',
	...
	'A highly excited man rang up for an ambulance. "Quickly, come quickly", he shouted, "My wife\'s about to have a baby."\n"Is this her first baby?" asked the operator.\n"No, you fool", came the reply, "It\'s her husband."',
	'A passer-by spots a fisherman by a river. "Is this a good river for fish?" he asks.\n"Yes", replies the fisherman, "It must be. I can\'t get any of them to come out."',
	...
	'A snake slithers into a pub and up to the bar. The landlord says, "I\'m sorry, but I can\'t serve you."\n"What? Why not?" asks the snake.\n"Because", says the landlord, "You can\'t hold your drink."',
	...
	'A depressed man turned to his friend in the pub and said, "I woke up this morning and felt so bad that I tried to kill myself by taking 50 aspirin."\n"Oh man, that\'s really bad", said his friend, "What happened?"\nThe first man sighed and said, "After the first two, I felt better."',
	...
	'As Sid sat down to a big plate of chips and gravy down the local pub, a mate of his came over and said, "Here Sid, me old pal. I thought you were trying to get into shape? And here you are with a high-fat meal and a pint of stout!"\nSid looked up and replied, "I am getting into shape. The shape I\'ve chosen is a sphere."',
	'Man in pub: How much do you charge for one single drop of whisky?\nLandlord: That would be free sir.\nMan in pub: Excellent. Drip me a glass full.',
	...
	'What\'s the diference between a sock and a camera?\nA sock takes five toes and a camera takes four toes!',
	'Woman on phone: I\'d like to complain about these incontinence pants I bought from you!\nShopkeeper: Certainly madam, where are you ringing from?\nWoman on phone: From the waist down!',
	'Knock knock.',
	'Two Oranges in a pub, one says to the other "Your round.".',
	'Guy: "Doc, I\'ve got a cricket ball stuck up my backside."\nDoc: "How\'s that?"\nGuy: "Don\'t you start..."',
	...
	'A man goes into a bar and orders a pint. After a few minutes he hears a voice that says, "Nice shoes". He looks around but the whole bar is empty apart from the barman at the other end of the bar.\nA few minutes later he hears the voice again. This time it says, "I like your shirt".\nHe beckons the barman over and tells him what\'s been happening to which the barman replies, "Ah, that would be the nuts sir. They\'re complimentary"!',
	'A man was sitting in a restaurant waiting for his meal when a big king prawn comes flying across the room and hits him on the back of the head. He turns around and the waiter said, "That\'s just for starters".',
